...
<div class="body">
	...
	<div class="content">
		<span class="tBlack22">Cargo:</span> <a href="cargo/nuevo.html" class="button"><img src="../img/mas.png" alt="mas">&nbsp;Nuevo</a>
		<br><br>		
		...
		<table id="lis_mantenimiento" class="listado">
			...
			<tbody>
				<c:forEach var="c" items="${requestScope.lCargo}">
				<tr>
					<td>
						<form action="cargo.html" method="post">
							<input type="hidden" name="del_car_id" value="${c.id_cargo}">
							<input type="submit" class="equis" value="">
						</form>
					</td>
					<td>${c.nombre_cargo}</td>					
					<td>
						<form action="cargo/editar.html" method="post">
							<input type="submit" value="Editar"> 
							<input type="hidden" name="car_id" value="${c.id_cargo}">
						</form>
					</td>
				</tr>
				</c:forEach>
