...
<div class="body">
	...
	<div class="content">
		<span class="tBlack22">Tipo de Comisi&#243;n:</span> <a href="tipo/nuevo.html" class="button"><img src="../img/mas.png" alt="mas">&nbsp;Nuevo</a>
		<br><br>		
		...
		<table id="lis_mantenimiento" class="listado">
			...
			<tbody>
				<c:forEach var="ct" items="${requestScope.lComisionTipo}">
				<tr>
					<td>
						<form action="tipo.html" method="post">
							<input type="hidden" name="del_com_tip_id" value="${ct.id_comision_tipo}">
							<input type="submit" class="equis" value="">
						</form>
					</td>
					<td>${ct.nombre_comision_tipo}</td>					
					<td>
						<form action="tipo/editar.html" method="post">
							<input type="submit" value="Editar"> 
							<input type="hidden" name="com_tip_id" value="${ct.id_comision_tipo}">
						</form>
					</td>
				</tr>
				</c:forEach>
