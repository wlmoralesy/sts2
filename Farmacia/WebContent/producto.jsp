...
<div class="body">
	...
	<div class="content">
		<span class="tBlack22">Producto:</span> <a href="producto/nuevo.html" class="button"><img src="img/mas.png" alt="mas">&nbsp;Nuevo</a>
		<br><br>
				...
				<tr>
					<td>
						<form action="producto.html" method="post">
							<input type="hidden" name="del_pro_id" value="${p.id_producto}">
					...
					<td>
						<form action="producto/editar.html" method="post">
							<input type="submit" value="Editar"> 
							<input type="hidden" name="pro_id" value="${p.id_producto}">
						</form>
					</td>
				</tr>
				</c:forEach>
